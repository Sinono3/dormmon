...
while True:
    ...
    if (process_idx % PROCESS_PERIOD) == 0:
        ...
        for face_encoding in face_encodings:
            ...
            matches = face_recognition.compare_faces(people_enc, face_encoding)
            name = "Unknown"

            # Look for the nearest face, check if it's even a match.
            face_distances = face_recognition.face_distance(people_enc, face_encoding)
